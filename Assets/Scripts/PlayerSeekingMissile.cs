...
public class PlayerSeekingMissile : MonoBehaviour
{
	...
	void FixedUpdate()
	{
		...
		GetComponent<Rigidbody>().AddForce(transform.forward*missleAccelerationForce*Time.deltaTime, ForceMode.Acceleration);
